...
public:
  ...
  union AArch64Value {
    AArch64Value() { reg = ARM64_REG_INVALID; imm = 0; fp = 0; mem.base = ARM64_REG_INVALID; mem.index = ARM64_REG_INVALID; mem.disp = 0; }
  ...
  union ARMValue {
    ARMValue() { reg = ARM_REG_INVALID; imm = 0; fp = 0; mem.base = ARM_REG_INVALID; mem.index = ARM_REG_INVALID; mem.scale = 0; mem.disp = 0; }
  ...
  union MIPSValue {
    MIPSValue() { reg = MIPS_REG_INVALID; imm = 0; fp = 0; mem.base = MIPS_REG_INVALID; mem.disp = 0; }
  ...
  union PPCValue {
    PPCValue() { reg = PPC_REG_INVALID; imm = 0; mem.base = PPC_REG_INVALID; mem.disp = 0; }
  ...
  union X86Value {
    X86Value() { reg = X86_REG_INVALID; imm = 0; fp = 0; mem.segment = X86_REG_INVALID; mem.base = X86_REG_INVALID; mem.index = X86_REG_INVALID; mem.scale = 0; mem.disp = 0; }
