...
DS_PLUGIN_MODULE_EXPORT bool ds_plugin_module_init(ds::plugin::PluginHost *host) {
    ...
    if (!host->register_option_schema(std::move(e))) {
        ...
        (void) host->register_game_injector_export("DS_LUAJIT_fork_save", &DS_LUAJIT_fork_save);
    (void) host->register_game_injector_export("DS_LUAJIT_fork_save_exit", &DS_LUAJIT_fork_save_exit);
    (void) host->register_game_injector_export("DS_LUAJIT_fork_save_cleanup", &DS_LUAJIT_fork_save_cleanup);
    (void) host->register_game_injector_export("DS_LUAJIT_fork_save_wait", &DS_LUAJIT_fork_save_wait);
    (void) host->register_game_injector_export("DS_LUAJIT_fork_save_poll", &DS_LUAJIT_fork_save_poll);
