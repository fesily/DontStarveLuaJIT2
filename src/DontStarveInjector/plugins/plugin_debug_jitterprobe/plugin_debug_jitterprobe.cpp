...
extern "C" void DS_LUAJIT_jitter_probe_set_local_anim_own(bool on);
extern "C" int DS_LUAJIT_jitter_probe_get_local_anim_own();
...
DS_PLUGIN_MODULE_EXPORT bool ds_plugin_module_init(ds::plugin::PluginHost *host) {
    ...
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_set_local_anim_own",
                                              &DS_LUAJIT_jitter_probe_set_local_anim_own);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_local_anim_own",
                                              &DS_LUAJIT_jitter_probe_get_local_anim_own);
