...
extern "C" int DS_LUAJIT_jitter_probe_get_anim_hook_status();
extern "C" int DS_LUAJIT_jitter_probe_get_anim_call_count();
extern "C" int DS_LUAJIT_jitter_probe_get_anim_match_count();
extern "C" int DS_LUAJIT_jitter_probe_get_anim_preserve_count();
extern "C" int DS_LUAJIT_jitter_probe_get_perframe_calls();
extern "C" int DS_LUAJIT_jitter_probe_get_perframe_blocked();
extern "C" int DS_LUAJIT_jitter_probe_get_proxy_calls();
extern "C" int DS_LUAJIT_jitter_probe_get_proxy_blocked();
...
DS_PLUGIN_MODULE_EXPORT bool ds_plugin_module_init(ds::plugin::PluginHost *host) {
    ...
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_anim_hook_status",
                                              &DS_LUAJIT_jitter_probe_get_anim_hook_status);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_anim_call_count",
                                              &DS_LUAJIT_jitter_probe_get_anim_call_count);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_anim_match_count",
                                              &DS_LUAJIT_jitter_probe_get_anim_match_count);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_anim_preserve_count",
                                              &DS_LUAJIT_jitter_probe_get_anim_preserve_count);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_perframe_calls",
                                              &DS_LUAJIT_jitter_probe_get_perframe_calls);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_perframe_blocked",
                                              &DS_LUAJIT_jitter_probe_get_perframe_blocked);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_proxy_calls",
                                              &DS_LUAJIT_jitter_probe_get_proxy_calls);
    (void)host->register_game_injector_export("DS_LUAJIT_jitter_probe_get_proxy_blocked",
                                              &DS_LUAJIT_jitter_probe_get_proxy_blocked);
