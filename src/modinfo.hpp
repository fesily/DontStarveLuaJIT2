...
ModConfigurationOption<double,6> EnbaleFrameGC = {"EnbaleFrameGC", 1, {0, 1, 2, 3, 4, 5}};
ModConfigurationOption<double,7> TargetLogincFPS = {"TargetLogincFPS", 30, {30, 45, 60, 75, 90, 105, 120}};
