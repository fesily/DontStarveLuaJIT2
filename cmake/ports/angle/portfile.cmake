...
set(ANGLE_ENABLE_TRACE OFF)
set(ANGLE_ENABLE_TRACE_EVENTS OFF)
set(ANGLE_ALWAYS_LOG_INFO OFF)
set(ANGLE_ENABLE_VULKAN_VALIDATION_LAYERS OFF)
set(ANGLE_ENABLE_VULKAN_VALIDATION_LAYERS_BY_DEFAULT OFF)
set(ANGLE_ENABLE_VULKAN_API_DUMP_LAYER OFF)
...
set(ANGLE_PACKAGE_USE_VULKAN ${USE_VULKAN})
configure_file(
  "${CMAKE_CURRENT_LIST_DIR}/unofficial-angle-config.cmake"
  "${SOURCE_PATH}/unofficial-angle-config.cmake"
  @ONLY
)
...
if (USE_VULKAN)
  ...
  file(READ "${_vulkan_build_gn}" _vulkan_build_gn_contents)
  string(REPLACE "import(\"//build_overrides/swiftshader.gni\")"
                 "declare_args() {\n  angle_enable_swiftshader = false\n}"
                 _vulkan_build_gn_contents
                 "${_vulkan_build_gn_contents}")
  file(WRITE "${_vulkan_build_gn}" "${_vulkan_build_gn_contents}")
endif()
...
if (USE_VULKAN)
  set(_generated_vulkan_cmake "${SOURCE_PATH}/Vulkan.cmake")
  file(READ "${_generated_vulkan_cmake}" _generated_vulkan_cmake_contents)
  string(REPLACE
      "if(is_linux OR is_chromeos)\n    list(APPEND vulkan_backend_sourcesendif()"
      "if(is_linux OR is_chromeos)\n    list(APPEND vulkan_backend_sources\n        ${vulkan_backend_dma_buf_sources}\n    )\nendif()"
      _generated_vulkan_cmake_contents
      "${_generated_vulkan_cmake_contents}"
  )
  file(WRITE "${_generated_vulkan_cmake}" "${_generated_vulkan_cmake_contents}")
endif()
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        "-DANGLE_ENABLE_TRACE=${ANGLE_ENABLE_TRACE}"
        "-DANGLE_ENABLE_TRACE_EVENTS=${ANGLE_ENABLE_TRACE_EVENTS}"
        "-DANGLE_ALWAYS_LOG_INFO=${ANGLE_ALWAYS_LOG_INFO}"
        "-DANGLE_ENABLE_VULKAN_VALIDATION_LAYERS=${ANGLE_ENABLE_VULKAN_VALIDATION_LAYERS}"
        "-DANGLE_ENABLE_VULKAN_VALIDATION_LAYERS_BY_DEFAULT=${ANGLE_ENABLE_VULKAN_VALIDATION_LAYERS_BY_DEFAULT}"
        "-DANGLE_ENABLE_VULKAN_API_DUMP_LAYER=${ANGLE_ENABLE_VULKAN_API_DUMP_LAYER}"
)
