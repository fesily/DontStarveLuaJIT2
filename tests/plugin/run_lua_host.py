...
SCRIPT = SELF_DIR / "plugin_host_lua_spec.lua"
...
def main() -> int:
    ...
    for command in lua_command_candidates():
        ...
        if result.returncode != 0 and "module 'plugins.host'" in (result.stderr or ""):
            # Retry next candidate only when package path failed oddly; otherwise surface.
            pass
