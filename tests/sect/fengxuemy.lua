...
local function main(serstr, myenv, ...)
    ...
    local insss = {}
    local function precall(func, funcupvals, funcenv, depth)
        local v64 = func[1]
        local v65 = func[2]
        local v66 = func[3]
        return function(...)
            ...
            local memory = {}
            for v85 = 0, v75 do
                if (v85 >= num_param) then
                    v73[v85 - num_param] =
                        v74[v85 + 1]
                else
                    memory[v85] = v74[v85 + 1]
                end
            end
            local v78 = (v75 - num_param) + 1
            local bc
            local op
            depth = depth or 0
            local ttt = ""
            ...
            while true do
                bc = bcs[pc]
                op = bc[1]
                insss[#insss + 1] = {ttt, pc, bc[1], bc[2], bc[3], bc[4]}
                ...
                elseif op == 28 or op == 101 then
                    ...
                    memory[bc[2]] = precall(v122, upvals, funcenv, depth + 1)  -- 创建闭包
                ...
                elseif op == 47 or op == 89 then
                    memory[bc[2]] = precall(subs[bc[3]], nil, funcenv,  depth + 1)  -- 创建闭包
